...
public class CustomTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
	...
	public OAuth2Authentication loadAuthentication(String accessTokenValue)
		...
		List<GrantedAuthority> authorities = (List<GrantedAuthority>) accessToken.getAdditionalInformation().get("authorities");
		OAuth2Request newRequest = new OAuth2Request(oAuth2Request.getRequestParameters(), oAuth2Request.getClientId(),
				authorities, oAuth2Request.isApproved(), oAuth2Request.getScope(),
				oAuth2Request.getResourceIds(), oAuth2Request.getRedirectUri(), oAuth2Request.getResponseTypes(),
				oAuth2Request.getExtensions());
		result = new OAuth2Authentication(newRequest, new UsernamePasswordAuthenticationToken(result.getPrincipal(), "N/A", authorities));
		if (result == null) {
